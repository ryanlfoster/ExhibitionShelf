...
- (void)viewDidLoad
{
    ...
    [_navigationBar setTitleVerticalPositionAdjustment:5.0f forBarMetrics:UIBarMetricsDefault];
...
{
    vc.view.frame = CGRectMake(0, 36, self.view.bounds.size.width, self.view.bounds.size.height - _customTabBar.frame.size.height);
